...
const bheadings = TextStyle(
                      fontSize: 25.0,
                      fontWeight: FontWeight.w900,
                      color: Colors.black);

const navheadings = TextStyle(
                      fontSize: 16.0,
                      fontWeight: FontWeight.w600,
                      color: Colors.white);

const sideheadings = TextStyle(
                      fontSize: 16.0,
                      fontWeight: FontWeight.w600,
                      color: Colors.black);
...
const kPadding = 20.0;
const kPrimaryColor = Color.fromARGB(255, 244, 245, 247); //primary color of our website
...
const buttonColor2 = Color(0xFFA5D6A7);
